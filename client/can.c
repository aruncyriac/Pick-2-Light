 ...
 * Author: arunc
 *
 * Created on 28 January, 2025, 10:50 AM
 */
...
void can_transmit(void)
{
	...
	TXB0D0 = t[0];			/* DataByte 0 */
	TXB0D1 = t[1];			/* DataByte 1 */
	TXB0D2 = t[2];			/* DataByte 2 */
	TXB0D3 = t[3];			/* DataByte 3 */
	TXB0D4 = t[4];			/* DataByte 4 */
	TXB0D5 = t[5];			/* DataByte 5 */
	TXB0D6 = t[6];			/* DataByte 6 */
	TXB0D7 = t[7];			/* DataByte 7 */
