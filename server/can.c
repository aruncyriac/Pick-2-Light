 ...
 * Author: arunc
 *
 * Created on 22 February, 2025, 10:52 AM
 */
...
void init_can(void)
{
	...
	CAN_SET_OPERATION_MODE_NO_WAIT(e_can_op_mode_normal); //e_can_op_mode_loop
...
void can_transmit(void)
{
	...
	TXB0D0 = t[0]-48;			/* DataByte 0 */
	TXB0D1 = t[1]-48;			/* DataByte 1 */
	TXB0D2 = t[2]-48;			/* DataByte 2 */
	TXB0D3 = t[3]-48;			/* DataByte 3 */
	TXB0D4 = t[4]-48;			/* DataByte 4 */
	TXB0D5 = t[5]-48;			/* DataByte 5 */
	TXB0D6 = t[6]-48;			/* DataByte 6 */
	TXB0D7 = t[7]-48;			/* DataByte 7 */
